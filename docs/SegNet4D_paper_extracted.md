...
**Authors:** 15339, SegNet4D: Eﬃcient Instance-Aware 4D Semantic, Segmentation for LiDAR Point Cloud
...
experiments on the SemanticKITTI and nuScenes datasets
...
with state-of-the-art (SOTA) methods. The results conﬁrm
...
analysis, demonstrating the high eﬃciency of our method (Sec.
...
comparison, i.e., N = 3.
The quantitative results are presented in Tab. I. Our
...
our method boasts the fastest execution speed and is the only
...
IEEE TRANSACTIONS ON AUTOMATION SCIENCE AND ENGINEERING, VOL. 22, 2025
TABLE VI
RUNTIME ANALYSIS. THE BEST RESULT ARE IN BOLD
...
compare its results with the output of the proposed MSFM.
